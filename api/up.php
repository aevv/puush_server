...
while (!$found)
{
	...
	$access_res = mysql_query("SELECT * FROM " . $pPrefix . "upload WHERE access_name='".$access."'");
	$got = false;
...
mysql_query("INSERT INTO " . $pPrefix . "upload (name, time, user_id, access_name, private) VALUES ('".$file."', ".time().", ".$user_id.", '".$access."', ".$priv.")");
$id = mysql_insert_id();
